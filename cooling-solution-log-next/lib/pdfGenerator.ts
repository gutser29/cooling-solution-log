...
import type { EventRecord, Job, Invoice, Client } from './types'
...
// === COMPANY NAME (arriba derecha, encima del logo) ===
doc.setFontSize(10)
doc.setTextColor(30, 30, 30)
doc.setFont('helvetica', 'bold')
doc.text(COMPANY_NAME, pageW - marginR - 40, 10, { align: 'right' })
doc.setFont('helvetica', 'normal')

// === LOGO (debajo del nombre) ===
try {
...
doc.setTextColor(0, 150, 150)
doc.setFont('helvetica', 'bold')
doc.text(COMPANY_NAME, marginL, 20) // ← NOMBRE ARRIBA DE LA DIRECCIÓN
doc.setFont('helvetica', 'normal')
...
// ========== HEADER RIGHT (Logo centrado sobre "Bill To") ==========
// El logo va arriba derecha, centrado sobre donde va "Bill To"
const logoWidth = 50
const logoHeight = 21
const logoX = pageW - marginR - logoWidth // Alineado a la derecha con margen
const logoY = 15 // Arriba de "Bill To" (que empieza en ~55)

try {
  doc.addImage('data:image/png;base64,' + LOGO_BASE64, 'PNG', logoX, logoY, logoWidth, logoHeight)
} catch (e) {
